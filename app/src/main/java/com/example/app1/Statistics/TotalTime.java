...
public class TotalTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.totaltime);


        String argument1 = getIntent().getStringExtra("time_arg");
        String argument2 = getIntent().getStringExtra("mesos_oros_time_arg");
        Log.d("GpxResults", "Argument Mesos Oros Time: " + Float.parseFloat(argument2)+ "kai" +argument1);
...
//        float value2 = 30f;
        ...
        BarChart chart = findViewById(R.id.chart_time);
