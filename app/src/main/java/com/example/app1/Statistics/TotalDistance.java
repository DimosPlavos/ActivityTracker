...
public class TotalDistance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.totaldistance);


        String argument1 = getIntent().getStringExtra("distance_arg");
        String argument2 = getIntent().getStringExtra("mesos_oros_distance_arg");
        Log.d("GpxResults", "Argument Mesos Oros Distance: " + Float.parseFloat(argument2)+ "kai" +argument1);
...
//        float value2 = 30f;
        ...
        BarChart chart = findViewById(R.id.chart_distance);
